...
`)+`
`+f);const y=E+m+o,x=E+f+a,R=Pc(i,i.VERTEX_SHADER,y),b=Pc(i,i.FRAGMENT_SHADER,x);i.attachShader(_,R),i.attachShader(_,b),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(P){if(s.debug.checkShaderErrors){const D=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(R).trim(),H=i.getShaderInfoLog(b).trim();let X=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,R,b);else{const j=Dc(i,R,"vertex"),V=Dc(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function e_(s,e,t){let n=new aa;const i=new Ve,r=new Ve,o=new Ke,a=new qh({depthPacking:Uu}),c=new Yh,l={},u=t.maxTextureSize,h={[Sn]:Pt,[Pt]:Sn,[tn]:tn},d=new On({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ve},radius:{value:4}},vertexShader:Jg,fragmentShader:Qg}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new an;g.setAttribute("position",new wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ft(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zc;let f=this.type;this.render=function(b,w,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const T=s.getRenderTarget(),S=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),D=s.state;D.setBlending(Nn),D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const O=f!==gn&&this.type===gn,H=f===gn&&this.type!==gn;for(let X=0,G=b.length;X<G;X++){const j=b[X],V=j.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;i.copy(V.mapSize);const se=V.getFrameExtents();if(i.multiply(se),r.copy(V.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/se.x),i.x=r.x*se.x,V.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/se.y),i.y=r.y*se.y,V.mapSize.y=r.y)),V.map===null||O===!0||H===!0){const Se=this.type!==gn?{minFilter:At,magFilter:At}:{};V.map!==null&&V.map.dispose(),V.map=new si(i.x,i.y,Se),V.map.texture.name=j.name+".shadowMap",V.camera.updateProjectionMatrix()}s.setRenderTarget(V.map),s.clear();const he=V.getViewportCount();for(let Se=0;Se<he;Se++){const Oe=V.getViewport(Se);o.set(r.x*Oe.x,r.y*Oe.y,r.x*Oe.z,r.y*Oe.w),D.viewport(o),V.updateMatrices(j,Se),n=V.getFrustum(),x(w,C,V.camera,j,this.type)}V.isPointLightShadow!==!0&&this.type===gn&&E(V,C),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(T,S,P)};function E(b,w){const C=e.update(_);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new si(i.x,i.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,s.setRenderTarget(b.mapPass),s.clear(),s.renderBufferDirect(w,null,C,d,_,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,s.setRenderTarget(b.map),s.clear(),s.renderBufferDirect(w,null,C,p,_,null)}function y(b,w,C,T){let S=null;const P=C.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(P!==void 0)S=P;else if(S=C.isPointLight===!0?c:a,s.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const D=S.uuid,O=w.uuid;let H=l[D];H===void 0&&(H={},l[D]=H);let X=H[O];X===void 0&&(X=S.clone(),H[O]=X,w.addEventListener("dispose",R)),S=X}if(S.visible=w.visible,S.wireframe=w.wireframe,T===gn?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:h[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const D=s.properties.get(S);D.light=C}return S}function x(b,w,C,T,S){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&S===gn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,b.matrixWorld);const O=e.update(b),H=b.material;if(Array.isArray(H)){const X=O.groups;for(let G=0,j=X.length;G<j;G++){const V=X[G],se=H[V.materialIndex];if(se&&se.visible){const he=y(b,se,T,S);b.onBeforeShadow(s,b,w,C,O,he,V),s.renderBufferDirect(C,null,O,he,b,V),b.onAfterShadow(s,b,w,C,O,he,V)}}}else if(H.visible){const X=y(b,H,T,S);b.onBeforeShadow(s,b,w,C,O,X,null),s.renderBufferDirect(C,null,O,X,b,null),b.onAfterShadow(s,b,w,C,O,X,null)}}const D=b.children;for(let O=0,H=D.length;O<H;O++)x(D[O],w,C,T,S)}function R(b){b.target.removeEventListener("dispose",R);for(const C in l){const T=l[C],S=b.target.uuid;S in T&&(T[S].dispose(),delete T[S])}}}const t_={[so]:ro,[oo]:lo,[ao]:uo,[Pi]:co,[ro]:so,[lo]:oo,[uo]:ao,[co]:Pi};function n_(s,e){function t(){let L=!1;const oe=new Ke;let J=null;const de=new Ke(0,0,0,0);return{setMask:function(Q){J!==Q&&!L&&(s.colorMask(Q,Q,Q,Q),J=Q)},setLocked:function(Q){L=Q},setClear:function(Q,K,fe,Le,it){it===!0&&(Q*=Le,K*=Le,fe*=Le),oe.set(Q,K,fe,Le),de.equals(oe)===!1&&(s.clearColor(Q,K,fe,Le),de.copy(oe))},reset:function(){L=!1,J=null,de.set(-1,0,0,0)}}}function n(){let L=!1,oe=!1,J=null,de=null,Q=null;return{setReversed:function(K){if(oe!==K){const fe=e.get("EXT_clip_control");K?fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.ZERO_TO_ONE_EXT):fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.NEGATIVE_ONE_TO_ONE_EXT),oe=K;const Le=Q;Q=null,this.setClear(Le)}},getReversed:function(){return oe},setTest:function(K){K?ce(s.DEPTH_TEST):Me(s.DEPTH_TEST)},setMask:function(K){J!==K&&!L&&(s.depthMask(K),J=K)},setFunc:function(K){if(oe&&(K=t_[K]),de!==K){switch(K){case so:s.depthFunc(s.NEVER);break;case ro:s.depthFunc(s.ALWAYS);break;case oo:s.depthFunc(s.LESS);break;case Pi:s.depthFunc(s.LEQUAL);break;case ao:s.depthFunc(s.EQUAL);break;case co:s.depthFunc(s.GEQUAL);break;case lo:s.depthFunc(s.GREATER);break;case uo:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}de=K}},setLocked:function(K){L=K},setClear:function(K){Q!==K&&(oe&&(K=1-K),s.clearDepth(K),Q=K)},reset:function(){L=!1,J=null,de=null,Q=null,oe=!1}}}function i(){let L=!1,oe=null,J=null,de=null,Q=null,K=null,fe=null,Le=null,it=null;return{setTest:function(Ze){L||(Ze?ce(s.STENCIL_TEST):Me(s.STENCIL_TEST))},setMask:function(Ze){oe!==Ze&&!L&&(s.stencilMask(Ze),oe=Ze)},setFunc:function(Ze,Vt,ln){(J!==Ze||de!==Vt||Q!==ln)&&(s.stencilFunc(Ze,Vt,ln),J=Ze,de=Vt,Q=ln)},setOp:function(Ze,Vt,ln){(K!==Ze||fe!==Vt||Le!==ln)&&(s.stencilOp(Ze,Vt,ln),K=Ze,fe=Vt,Le=ln)},setLocked:function(Ze){L=Ze},setClear:function(Ze){it!==Ze&&(s.clearStencil(Ze),it=Ze)},reset:function(){L=!1,oe=null,J=null,de=null,Q=null,K=null,fe=null,Le=null,it=null}}}const r=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,E=null,y=null,x=null,R=null,b=null,w=new Ie(0,0,0),C=0,T=!1,S=null,P=null,D=null,O=null,H=null;const X=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,j=0;const V=s.getParameter(s.VERSION);V.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(V)[1]),G=j>=1):V.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),G=j>=2);let se=null,he={};const Se=s.getParameter(s.SCISSOR_BOX),Oe=s.getParameter(s.VIEWPORT),tt=new Ke().fromArray(Se),Y=new Ke().fromArray(Oe);function te(L,oe,J,de){const Q=new Uint8Array(4),K=s.createTexture();s.bindTexture(L,K),s.texParameteri(L,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(L,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let fe=0;fe<J;fe++)L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY?s.texImage3D(oe,0,s.RGBA,1,1,de,0,s.RGBA,s.UNSIGNED_BYTE,Q):s.texImage2D(oe+fe,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Q);return K}const xe={};xe[s.TEXTURE_2D]=te(s.TEXTURE_2D,s.TEXTURE_2D,1),xe[s.TEXTURE_CUBE_MAP]=te(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),xe[s.TEXTURE_2D_ARRAY]=te(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),xe[s.TEXTURE_3D]=te(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ce(s.DEPTH_TEST),o.setFunc(Pi),Ye(!1),nt(Aa),ce(s.CULL_FACE),I(Nn);function ce(L){u[L]!==!0&&(s.enable(L),u[L]=!0)}function Me(L){u[L]!==!1&&(s.disable(L),u[L]=!1)}function Xe(L,oe){return h[L]!==oe?(s.bindFramebuffer(L,oe),h[L]=oe,L===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=oe),L===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=oe),!0):!1}function we(L,oe){let J=p,de=!1;if(L){J=d.get(oe),J===void 0&&(J=[],d.set(oe,J));const Q=L.textures;if(J.length!==Q.length||J[0]!==s.COLOR_ATTACHMENT0){for(let K=0,fe=Q.length;K<fe;K++)J[K]=s.COLOR_ATTACHMENT0+K;J.length=Q.length,de=!0}}else J[0]!==s.BACK&&(J[0]=s.BACK,de=!0);de&&s.drawBuffers(J)}function ot(L){return g!==L?(s.useProgram(L),g=L,!0):!1}const at={[Zn]:s.FUNC_ADD,[nu]:s.FUNC_SUBTRACT,[iu]:s.FUNC_REVERSE_SUBTRACT};at[su]=s.MIN,at[ru]=s.MAX;const qe={[ou]:s.ZERO,[au]:s.ONE,[cu]:s.SRC_COLOR,[no]:s.SRC_ALPHA,[pu]:s.SRC_ALPHA_SATURATE,[du]:s.DST_COLOR,[uu]:s.DST_ALPHA,[lu]:s.ONE_MINUS_SRC_COLOR,[io]:s.ONE_MINUS_SRC_ALPHA,[fu]:s.ONE_MINUS_DST_COLOR,[hu]:s.ONE_MINUS_DST_ALPHA,[mu]:s.CONSTANT_COLOR,[gu]:s.ONE_MINUS_CONSTANT_COLOR,[_u]:s.CONSTANT_ALPHA,[vu]:s.ONE_MINUS_CONSTANT_ALPHA};function I(L,oe,J,de,Q,K,fe,Le,it,Ze){if(L===Nn){_===!0&&(Me(s.BLEND),_=!1);return}if(_===!1&&(ce(s.BLEND),_=!0),L!==tu){if(L!==m||Ze!==T){if((f!==Zn||x!==Zn)&&(s.blendEquation(s.FUNC_ADD),f=Zn,x=Zn),Ze)switch(L){case wi:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case wa:s.blendFunc(s.ONE,s.ONE);break;case Ra:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Ca:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case wi:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case wa:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Ra:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Ca:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}E=null,y=null,R=null,b=null,w.set(0,0,0),C=0,m=L,T=Ze}return}Q=Q||oe,K=K||J,fe=fe||de,(oe!==f||Q!==x)&&(s.blendEquationSeparate(at[oe],at[Q]),f=oe,x=Q),(J!==E||de!==y||K!==R||fe!==b)&&(s.blendFuncSeparate(qe[J],qe[de],qe[K],qe[fe]),E=J,y=de,R=K,b=fe),(Le.equals(w)===!1||it!==C)&&(s.blendColor(Le.r,Le.g,Le.b,it),w.copy(Le),C=it),m=L,T=!1}function Mt(L,oe){L.side===tn?Me(s.CULL_FACE):ce(s.CULL_FACE);let J=L.side===Pt;oe&&(J=!J),Ye(J),L.blending===wi&&L.transparent===!1?I(Nn):I(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),r.setMask(L.colorWrite);const de=L.stencilWrite;a.setTest(de),de&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Ge(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ce(s.SAMPLE_ALPHA_TO_COVERAGE):Me(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ye(L){S!==L&&(L?s.frontFace(s.CW):s.frontFace(s.CCW),S=L)}function nt(L){L!==Jl?(ce(s.CULL_FACE),L!==P&&(L===Aa?s.cullFace(s.BACK):L===Ql?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Me(s.CULL_FACE),P=L}function ge(L){L!==D&&(G&&s.lineWidth(L),D=L)}function Ge(L,oe,J){L?(ce(s.POLYGON_OFFSET_FILL),(O!==oe||H!==J)&&(s.polygonOffset(oe,J),O=oe,H=J)):Me(s.POLYGON_OFFSET_FILL)}function Ee(L){L?ce(s.SCISSOR_TEST):Me(s.SCISSOR_TEST)}function Ne(L){L===void 0&&(L=s.TEXTURE0+X-1),se!==L&&(s.activeTexture(L),se=L)}function ht(L,oe,J){J===void 0&&(se===null?J=s.TEXTURE0+X-1:J=se);let de=he[J];de===void 0&&(de={type:void 0,texture:void 0},he[J]=de),(de.type!==L||de.texture!==oe)&&(se!==J&&(s.activeTexture(J),se=J),s.bindTexture(L,oe||xe[L]),de.type=L,de.texture=oe)}function A(){const L=he[se];L!==void 0&&L.type!==void 0&&(s.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function v(){try{s.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function B(){try{s.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function q(){try{s.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function $(){try{s.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function W(){try{s.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _e(){try{s.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function re(){try{s.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function me(){try{s.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ve(){try{s.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{s.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function le(L){tt.equals(L)===!1&&(s.scissor(L.x,L.y,L.z,L.w),tt.copy(L))}function Ae(L){Y.equals(L)===!1&&(s.viewport(L.x,L.y,L.z,L.w),Y.copy(L))}function be(L,oe){let J=l.get(oe);J===void 0&&(J=new WeakMap,l.set(oe,J));let de=J.get(L);de===void 0&&(de=s.getUniformBlockIndex(oe,L.name),J.set(L,de))}function ne(L,oe){const de=l.get(oe).get(L);c.get(oe)!==de&&(s.uniformBlockBinding(oe,de,L.__bindingPointIndex),c.set(oe,de))}function Pe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),u={},se=null,he={},h={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,E=null,y=null,x=null,R=null,b=null,w=new Ie(0,0,0),C=0,T=!1,S=null,P=null,D=null,O=null,H=null,tt.set(0,0,s.canvas.width,s.canvas.height),Y.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:ce,disable:Me,bindFramebuffer:Xe,drawBuffers:we,useProgram:ot,setBlending:I,setMaterial:Mt,setFlipSided:Ye,setCullFace:nt,setLineWidth:ge,setPolygonOffset:Ge,setScissorTest:Ee,activeTexture:Ne,bindTexture:ht,unbindTexture:A,compressedTexImage2D:v,compressedTexImage3D:B,texImage2D:ve,texImage3D:Z,updateUBOMapping:be,uniformBlockBinding:ne,texStorage2D:re,texStorage3D:me,texSubImage2D:q,texSubImage3D:$,compressedTexSubImage2D:W,compressedTexSubImage3D:_e,scissor:le,viewport:Ae,reset:Pe}}function i_(s,e,t,n,i,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ve,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,v){return p?new OffscreenCanvas(A,v):fs("canvas")}function _(A,v,B){let q=1;const $=ht(A);if(($.width>B||$.height>B)&&(q=B/Math.max($.width,$.height)),q<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const W=Math.floor(q*$.width),_e=Math.floor(q*$.height);h===void 0&&(h=g(W,_e));const re=v?g(W,_e):h;return re.width=W,re.height=_e,re.getContext("2d").drawImage(A,0,0,W,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+W+"x"+_e+")."),re}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),A;return A}function m(A){return A.generateMipmaps}function f(A){s.generateMipmap(A)}function E(A){return A.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?s.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function y(A,v,B,q,$=!1){if(A!==null){if(s[A]!==void 0)return s[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let W=v;if(v===s.RED&&(B===s.FLOAT&&(W=s.R32F),B===s.HALF_FLOAT&&(W=s.R16F),B===s.UNSIGNED_BYTE&&(W=s.R8)),v===s.RED_INTEGER&&(B===s.UNSIGNED_BYTE&&(W=s.R8UI),B===s.UNSIGNED_SHORT&&(W=s.R16UI),B===s.UNSIGNED_INT&&(W=s.R32UI),B===s.BYTE&&(W=s.R8I),B===s.SHORT&&(W=s.R16I),B===s.INT&&(W=s.R32I)),v===s.RG&&(B===s.FLOAT&&(W=s.RG32F),B===s.HALF_FLOAT&&(W=s.RG16F),B===s.UNSIGNED_BYTE&&(W=s.RG8)),v===s.RG_INTEGER&&(B===s.UNSIGNED_BYTE&&(W=s.RG8UI),B===s.UNSIGNED_SHORT&&(W=s.RG16UI),B===s.UNSIGNED_INT&&(W=s.RG32UI),B===s.BYTE&&(W=s.RG8I),B===s.SHORT&&(W=s.RG16I),B===s.INT&&(W=s.RG32I)),v===s.RGB_INTEGER&&(B===s.UNSIGNED_BYTE&&(W=s.RGB8UI),B===s.UNSIGNED_SHORT&&(W=s.RGB16UI),B===s.UNSIGNED_INT&&(W=s.RGB32UI),B===s.BYTE&&(W=s.RGB8I),B===s.SHORT&&(W=s.RGB16I),B===s.INT&&(W=s.RGB32I)),v===s.RGBA_INTEGER&&(B===s.UNSIGNED_BYTE&&(W=s.RGBA8UI),B===s.UNSIGNED_SHORT&&(W=s.RGBA16UI),B===s.UNSIGNED_INT&&(W=s.RGBA32UI),B===s.BYTE&&(W=s.RGBA8I),B===s.SHORT&&(W=s.RGBA16I),B===s.INT&&(W=s.RGBA32I)),v===s.RGB&&B===s.UNSIGNED_INT_5_9_9_9_REV&&(W=s.RGB9_E5),v===s.RGBA){const _e=$?rr:He.getTransfer(q);B===s.FLOAT&&(W=s.RGBA32F),B===s.HALF_FLOAT&&(W=s.RGBA16F),B===s.UNSIGNED_BYTE&&(W=_e===et?s.SRGB8_ALPHA8:s.RGBA8),B===s.UNSIGNED_SHORT_4_4_4_4&&(W=s.RGBA4),B===s.UNSIGNED_SHORT_5_5_5_1&&(W=s.RGB5_A1)}return(W===s.R16F||W===s.R32F||W===s.RG16F||W===s.RG32F||W===s.RGBA16F||W===s.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function x(A,v){let B;return A?v===null||v===ii||v===cs?B=s.DEPTH24_STENCIL8:v===jt?B=s.DEPTH32F_STENCIL8:v===as&&(B=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===ii||v===cs?B=s.DEPTH_COMPONENT24:v===jt?B=s.DEPTH_COMPONENT32F:v===as&&(B=s.DEPTH_COMPONENT16),B}function R(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==At&&A.minFilter!==Nt?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function b(A){const v=A.target;v.removeEventListener("dispose",b),C(v),v.isVideoTexture&&u.delete(v)}function w(A){const v=A.target;v.removeEventListener("dispose",w),S(v)}function C(A){const v=n.get(A);if(v.__webglInit===void 0)return;const B=A.source,q=d.get(B);if(q){const $=q[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&T(A),Object.keys(q).length===0&&d.delete(B)}n.remove(A)}function T(A){const v=n.get(A);s.deleteTexture(v.__webglTexture);const B=A.source,q=d.get(B);delete q[v.__cacheKey],o.memory.textures--}function S(A){const v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let $=0;$<v.__webglFramebuffer[q].length;$++)s.deleteFramebuffer(v.__webglFramebuffer[q][$]);else s.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)s.deleteFramebuffer(v.__webglFramebuffer[q]);else s.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&s.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&s.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&s.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const B=A.textures;for(let q=0,$=B.length;q<$;q++){const W=n.get(B[q]);W.__webglTexture&&(s.deleteTexture(W.__webglTexture),o.memory.textures--),n.remove(B[q])}n.remove(A)}let P=0;function D(){P=0}function O(){const A=P;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),P+=1,A}function H(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function X(A,v){const B=n.get(A);if(A.isVideoTexture&&Ee(A),A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){const q=A.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{xe(B,A,v);return}}t.bindTexture(s.TEXTURE_2D,B.__webglTexture,s.TEXTURE0+v)}function G(A,v){const B=n.get(A);if(A.version>0&&B.__version!==A.version){xe(B,A,v);return}t.bindTexture(s.TEXTURE_2D_ARRAY,B.__webglTexture,s.TEXTURE0+v)}function j(A,v){const B=n.get(A);if(A.version>0&&B.__version!==A.version){xe(B,A,v);return}t.bindTexture(s.TEXTURE_3D,B.__webglTexture,s.TEXTURE0+v)}function V(A,v){const B=n.get(A);if(A.version>0&&B.__version!==A.version){ce(B,A,v);return}t.bindTexture(s.TEXTURE_CUBE_MAP,B.__webglTexture,s.TEXTURE0+v)}const se={[Ui]:s.REPEAT,[Dn]:s.CLAMP_TO_EDGE,[ir]:s.MIRRORED_REPEAT},he={[At]:s.NEAREST,[el]:s.NEAREST_MIPMAP_NEAREST,[ns]:s.NEAREST_MIPMAP_LINEAR,[Nt]:s.LINEAR,[Ys]:s.LINEAR_MIPMAP_NEAREST,[vn]:s.LINEAR_MIPMAP_LINEAR},Se={[Fu]:s.NEVER,[Vu]:s.ALWAYS,[Ou]:s.LESS,[hl]:s.LEQUAL,[Bu]:s.EQUAL,[Hu]:s.GEQUAL,[ku]:s.GREATER,[zu]:s.NOTEQUAL};function Oe(A,v){if(v.type===jt&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Nt||v.magFilter===Ys||v.magFilter===ns||v.magFilter===vn||v.minFilter===Nt||v.minFilter===Ys||v.minFilter===ns||v.minFilter===vn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(A,s.TEXTURE_WRAP_S,se[v.wrapS]),s.texParameteri(A,s.TEXTURE_WRAP_T,se[v.wrapT]),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,se[v.wrapR]),s.texParameteri(A,s.TEXTURE_MAG_FILTER,he[v.magFilter]),s.texParameteri(A,s.TEXTURE_MIN_FILTER,he[v.minFilter]),v.compareFunction&&(s.texParameteri(A,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(A,s.TEXTURE_COMPARE_FUNC,Se[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===At||v.minFilter!==ns&&v.minFilter!==vn||v.type===jt&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");s.texParameterf(A,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function tt(A,v){let B=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",b));const q=v.source;let $=d.get(q);$===void 0&&($={},d.set(q,$));const W=H(v);if(W!==A.__cacheKey){$[W]===void 0&&($[W]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,B=!0),$[W].usedTimes++;const _e=$[A.__cacheKey];_e!==void 0&&($[A.__cacheKey].usedTimes--,_e.usedTimes===0&&T(v)),A.__cacheKey=W,A.__webglTexture=$[W].texture}return B}function Y(A,v,B){return Math.floor(Math.floor(A/B)/v)}function te(A,v,B,q){const W=A.updateRanges;if(W.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,v.width,v.height,B,q,v.data);else{W.sort((Z,le)=>Z.start-le.start);let _e=0;for(let Z=1;Z<W.length;Z++){const le=W[_e],Ae=W[Z],be=le.start+le.count,ne=Y(Ae.start,v.width,4),Pe=Y(le.start,v.width,4);Ae.start<=be+1&&ne===Pe&&Y(Ae.start+Ae.count-1,v.width,4)===ne?le.count=Math.max(le.count,Ae.start+Ae.count-le.start):(++_e,W[_e]=Ae)}W.length=_e+1;const re=s.getParameter(s.UNPACK_ROW_LENGTH),me=s.getParameter(s.UNPACK_SKIP_PIXELS),ve=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,v.width);for(let Z=0,le=W.length;Z<le;Z++){const Ae=W[Z],be=Math.floor(Ae.start/4),ne=Math.ceil(Ae.count/4),Pe=be%v.width,L=Math.floor(be/v.width),oe=ne,J=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Pe),s.pixelStorei(s.UNPACK_SKIP_ROWS,L),t.texSubImage2D(s.TEXTURE_2D,0,Pe,L,oe,J,B,q,v.data)}A.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,re),s.pixelStorei(s.UNPACK_SKIP_PIXELS,me),s.pixelStorei(s.UNPACK_SKIP_ROWS,ve)}}function xe(A,v,B){let q=s.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=s.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=s.TEXTURE_3D);const $=tt(A,v),W=v.source;t.bindTexture(q,A.__webglTexture,s.TEXTURE0+B);const _e=n.get(W);if(W.version!==_e.__version||$===!0){t.activeTexture(s.TEXTURE0+B);const re=He.getPrimaries(He.workingColorSpace),me=v.colorSpace===Ln?null:He.getPrimaries(v.colorSpace),ve=v.colorSpace===Ln||re===me?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);let Z=_(v.image,!1,i.maxTextureSize);Z=Ne(v,Z);const le=r.convert(v.format,v.colorSpace),Ae=r.convert(v.type);let be=y(v.internalFormat,le,Ae,v.colorSpace,v.isVideoTexture);Oe(q,v);let ne;const Pe=v.mipmaps,L=v.isVideoTexture!==!0,oe=_e.__version===void 0||$===!0,J=W.dataReady,de=R(v,Z);if(v.isDepthTexture)be=x(v.format===us,v.type),oe&&(L?t.texStorage2D(s.TEXTURE_2D,1,be,Z.width,Z.height):t.texImage2D(s.TEXTURE_2D,0,be,Z.width,Z.height,0,le,Ae,null));else if(v.isDataTexture)if(Pe.length>0){L&&oe&&t.texStorage2D(s.TEXTURE_2D,de,be,Pe[0].width,Pe[0].height);for(let Q=0,K=Pe.length;Q<K;Q++)ne=Pe[Q],L?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ne.width,ne.height,le,Ae,ne.data):t.texImage2D(s.TEXTURE_2D,Q,be,ne.width,ne.height,0,le,Ae,ne.data);v.generateMipmaps=!1}else L?(oe&&t.texStorage2D(s.TEXTURE_2D,de,be,Z.width,Z.height),J&&te(v,Z,le,Ae)):t.texImage2D(s.TEXTURE_2D,0,be,Z.width,Z.height,0,le,Ae,Z.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){L&&oe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,be,Pe[0].width,Pe[0].height,Z.depth);for(let Q=0,K=Pe.length;Q<K;Q++)if(ne=Pe[Q],v.format!==Ht)if(le!==null)if(L){if(J)if(v.layerUpdates.size>0){const fe=gc(ne.width,ne.height,v.format,v.type);for(const Le of v.layerUpdates){const it=ne.data.subarray(Le*fe/ne.data.BYTES_PER_ELEMENT,(Le+1)*fe/ne.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,Le,ne.width,ne.height,1,le,it)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ne.width,ne.height,Z.depth,le,ne.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Q,be,ne.width,ne.height,Z.depth,0,ne.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?J&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ne.width,ne.height,Z.depth,le,Ae,ne.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Q,be,ne.width,ne.height,Z.depth,0,le,Ae,ne.data)}else{L&&oe&&t.texStorage2D(s.TEXTURE_2D,de,be,Pe[0].width,Pe[0].height);for(let Q=0,K=Pe.length;Q<K;Q++)ne=Pe[Q],v.format!==Ht?le!==null?L?J&&t.compressedTexSubImage2D(s.TEXTURE_2D,Q,0,0,ne.width,ne.height,le,ne.data):t.compressedTexImage2D(s.TEXTURE_2D,Q,be,ne.width,ne.height,0,ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ne.width,ne.height,le,Ae,ne.data):t.texImage2D(s.TEXTURE_2D,Q,be,ne.width,ne.height,0,le,Ae,ne.data)}else if(v.isDataArrayTexture)if(L){if(oe&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,be,Z.width,Z.height,Z.depth),J)if(v.layerUpdates.size>0){const Q=gc(Z.width,Z.height,v.format,v.type);for(const K of v.layerUpdates){const fe=Z.data.subarray(K*Q/Z.data.BYTES_PER_ELEMENT,(K+1)*Q/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,Z.width,Z.height,1,le,Ae,fe)}v.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,le,Ae,Z.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,be,Z.width,Z.height,Z.depth,0,le,Ae,Z.data);else if(v.isData3DTexture)L?(oe&&t.texStorage3D(s.TEXTURE_3D,de,be,Z.width,Z.height,Z.depth),J&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,le,Ae,Z.data)):t.texImage3D(s.TEXTURE_3D,0,be,Z.width,Z.height,Z.depth,0,le,Ae,Z.data);else if(v.isFramebufferTexture){if(oe)if(L)t.texStorage2D(s.TEXTURE_2D,de,be,Z.width,Z.height);else{let Q=Z.width,K=Z.height;for(let fe=0;fe<de;fe++)t.texImage2D(s.TEXTURE_2D,fe,be,Q,K,0,le,Ae,null),Q>>=1,K>>=1}}else if(Pe.length>0){if(L&&oe){const Q=ht(Pe[0]);t.texStorage2D(s.TEXTURE_2D,de,be,Q.width,Q.height)}for(let Q=0,K=Pe.length;Q<K;Q++)ne=Pe[Q],L?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,le,Ae,ne):t.texImage2D(s.TEXTURE_2D,Q,be,le,Ae,ne);v.generateMipmaps=!1}else if(L){if(oe){const Q=ht(Z);t.texStorage2D(s.TEXTURE_2D,de,be,Q.width,Q.height)}J&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,le,Ae,Z)}else t.texImage2D(s.TEXTURE_2D,0,be,le,Ae,Z);m(v)&&f(q),_e.__version=W.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function ce(A,v,B){if(v.image.length!==6)return;const q=tt(A,v),$=v.source;t.bindTexture(s.TEXTURE_CUBE_MAP,A.__webglTexture,s.TEXTURE0+B);const W=n.get($);if($.version!==W.__version||q===!0){t.activeTexture(s.TEXTURE0+B);const _e=He.getPrimaries(He.workingColorSpace),re=v.colorSpace===Ln?null:He.getPrimaries(v.colorSpace),me=v.colorSpace===Ln||_e===re?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const ve=v.isCompressedTexture||v.image[0].isCompressedTexture,Z=v.image[0]&&v.image[0].isDataTexture,le=[];for(let K=0;K<6;K++)!ve&&!Z?le[K]=_(v.image[K],!0,i.maxCubemapSize):le[K]=Z?v.image[K].image:v.image[K],le[K]=Ne(v,le[K]);const Ae=le[0],be=r.convert(v.format,v.colorSpace),ne=r.convert(v.type),Pe=y(v.internalFormat,be,ne,v.colorSpace),L=v.isVideoTexture!==!0,oe=W.__version===void 0||q===!0,J=$.dataReady;let de=R(v,Ae);Oe(s.TEXTURE_CUBE_MAP,v);let Q;if(ve){L&&oe&&t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Pe,Ae.width,Ae.height);for(let K=0;K<6;K++){Q=le[K].mipmaps;for(let fe=0;fe<Q.length;fe++){const Le=Q[fe];v.format!==Ht?be!==null?L?J&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe,0,0,Le.width,Le.height,be,Le.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe,Pe,Le.width,Le.height,0,Le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe,0,0,Le.width,Le.height,be,ne,Le.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe,Pe,Le.width,Le.height,0,be,ne,Le.data)}}}else{if(Q=v.mipmaps,L&&oe){Q.length>0&&de++;const K=ht(le[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Pe,K.width,K.height)}for(let K=0;K<6;K++)if(Z){L?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,le[K].width,le[K].height,be,ne,le[K].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Pe,le[K].width,le[K].height,0,be,ne,le[K].data);for(let fe=0;fe<Q.length;fe++){const it=Q[fe].image[K].image;L?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe+1,0,0,it.width,it.height,be,ne,it.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe+1,Pe,it.width,it.height,0,be,ne,it.data)}}else{L?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,be,ne,le[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Pe,be,ne,le[K]);for(let fe=0;fe<Q.length;fe++){const Le=Q[fe];L?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe+1,0,0,be,ne,Le.image[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,fe+1,Pe,be,ne,Le.image[K])}}}m(v)&&f(s.TEXTURE_CUBE_MAP),W.__version=$.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Me(A,v,B,q,$,W){const _e=r.convert(B.format,B.colorSpace),re=r.convert(B.type),me=y(B.internalFormat,_e,re,B.colorSpace),ve=n.get(v),Z=n.get(B);if(Z.__renderTarget=v,!ve.__hasExternalTextures){const le=Math.max(1,v.width>>W),Ae=Math.max(1,v.height>>W);$===s.TEXTURE_3D||$===s.TEXTURE_2D_ARRAY?t.texImage3D($,W,me,le,Ae,v.depth,0,_e,re,null):t.texImage2D($,W,me,le,Ae,0,_e,re,null)}t.bindFramebuffer(s.FRAMEBUFFER,A),Ge(v)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,q,$,Z.__webglTexture,0,ge(v)):($===s.TEXTURE_2D||$>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,q,$,Z.__webglTexture,W),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Xe(A,v,B){if(s.bindRenderbuffer(s.RENDERBUFFER,A),v.depthBuffer){const q=v.depthTexture,$=q&&q.isDepthTexture?q.type:null,W=x(v.stencilBuffer,$),_e=v.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,re=ge(v);Ge(v)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,re,W,v.width,v.height):B?s.renderbufferStorageMultisample(s.RENDERBUFFER,re,W,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,W,v.width,v.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,_e,s.RENDERBUFFER,A)}else{const q=v.textures;for(let $=0;$<q.length;$++){const W=q[$],_e=r.convert(W.format,W.colorSpace),re=r.convert(W.type),me=y(W.internalFormat,_e,re,W.colorSpace),ve=ge(v);B&&Ge(v)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,ve,me,v.width,v.height):Ge(v)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ve,me,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,me,v.width,v.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function we(A,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(v.depthTexture);q.__renderTarget=v,(!q.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),X(v.depthTexture,0);const $=q.__webglTexture,W=ge(v);if(v.depthTexture.format===ls)Ge(v)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,$,0,W):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,$,0);else if(v.depthTexture.format===us)Ge(v)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,$,0,W):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function ot(A){const v=n.get(A),B=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const q=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){const $=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",$)};q.addEventListener("dispose",$),v.__depthDisposeCallback=$}v.__boundDepthTexture=q}if(A.depthTexture&&!v.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const q=A.texture.mipmaps;q&&q.length>0?we(v.__webglFramebuffer[0],A):we(v.__webglFramebuffer,A)}else if(B){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=s.createRenderbuffer(),Xe(v.__webglDepthbuffer[q],A,!1);else{const $=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer[q];s.bindRenderbuffer(s.RENDERBUFFER,W),s.framebufferRenderbuffer(s.FRAMEBUFFER,$,s.RENDERBUFFER,W)}}else{const q=A.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=s.createRenderbuffer(),Xe(v.__webglDepthbuffer,A,!1);else{const $=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,W),s.framebufferRenderbuffer(s.FRAMEBUFFER,$,s.RENDERBUFFER,W)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function at(A,v,B){const q=n.get(A);v!==void 0&&Me(q.__webglFramebuffer,A,A.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),B!==void 0&&ot(A)}function qe(A){const v=A.texture,B=n.get(A),q=n.get(v);A.addEventListener("dispose",w);const $=A.textures,W=A.isWebGLCubeRenderTarget===!0,_e=$.length>1;if(_e||(q.__webglTexture===void 0&&(q.__webglTexture=s.createTexture()),q.__version=v.version,o.memory.textures++),W){B.__webglFramebuffer=[];for(let re=0;re<6;re++)if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer[re]=[];for(let me=0;me<v.mipmaps.length;me++)B.__webglFramebuffer[re][me]=s.createFramebuffer()}else B.__webglFramebuffer[re]=s.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer=[];for(let re=0;re<v.mipmaps.length;re++)B.__webglFramebuffer[re]=s.createFramebuffer()}else B.__webglFramebuffer=s.createFramebuffer();if(_e)for(let re=0,me=$.length;re<me;re++){const ve=n.get($[re]);ve.__webglTexture===void 0&&(ve.__webglTexture=s.createTexture(),o.memory.textures++)}if(A.samples>0&&Ge(A)===!1){B.__webglMultisampledFramebuffer=s.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let re=0;re<$.length;re++){const me=$[re];B.__webglColorRenderbuffer[re]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,B.__webglColorRenderbuffer[re]);const ve=r.convert(me.format,me.colorSpace),Z=r.convert(me.type),le=y(me.internalFormat,ve,Z,me.colorSpace,A.isXRRenderTarget===!0),Ae=ge(A);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ae,le,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.RENDERBUFFER,B.__webglColorRenderbuffer[re])}s.bindRenderbuffer(s.RENDERBUFFER,null),A.depthBuffer&&(B.__webglDepthRenderbuffer=s.createRenderbuffer(),Xe(B.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(W){t.bindTexture(s.TEXTURE_CUBE_MAP,q.__webglTexture),Oe(s.TEXTURE_CUBE_MAP,v);for(let re=0;re<6;re++)if(v.mipmaps&&v.mipmaps.length>0)for(let me=0;me<v.mipmaps.length;me++)Me(B.__webglFramebuffer[re][me],A,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+re,me);else Me(B.__webglFramebuffer[re],A,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(v)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let re=0,me=$.length;re<me;re++){const ve=$[re],Z=n.get(ve);t.bindTexture(s.TEXTURE_2D,Z.__webglTexture),Oe(s.TEXTURE_2D,ve),Me(B.__webglFramebuffer,A,ve,s.COLOR_ATTACHMENT0+re,s.TEXTURE_2D,0),m(ve)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let re=s.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(re=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(re,q.__webglTexture),Oe(re,v),v.mipmaps&&v.mipmaps.length>0)for(let me=0;me<v.mipmaps.length;me++)Me(B.__webglFramebuffer[me],A,v,s.COLOR_ATTACHMENT0,re,me);else Me(B.__webglFramebuffer,A,v,s.COLOR_ATTACHMENT0,re,0);m(v)&&f(re),t.unbindTexture()}A.depthBuffer&&ot(A)}function I(A){const v=A.textures;for(let B=0,q=v.length;B<q;B++){const $=v[B];if(m($)){const W=E(A),_e=n.get($).__webglTexture;t.bindTexture(W,_e),f(W),t.unbindTexture()}}}const Mt=[],Ye=[];function nt(A){if(A.samples>0){if(Ge(A)===!1){const v=A.textures,B=A.width,q=A.height;let $=s.COLOR_BUFFER_BIT;const W=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_e=n.get(A),re=v.length>1;if(re)for(let ve=0;ve<v.length;ve++)t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ve,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ve,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const me=A.texture.mipmaps;me&&me.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let ve=0;ve<v.length;ve++){if(A.resolveDepthBuffer&&(A.depthBuffer&&($|=s.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&($|=s.STENCIL_BUFFER_BIT)),re){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,_e.__webglColorRenderbuffer[ve]);const Z=n.get(v[ve]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Z,0)}s.blitFramebuffer(0,0,B,q,0,0,B,q,$,s.NEAREST),c===!0&&(Mt.length=0,Ye.length=0,Mt.push(s.COLOR_ATTACHMENT0+ve),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Mt.push(W),Ye.push(W),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ye)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Mt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),re)for(let ve=0;ve<v.length;ve++){t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ve,s.RENDERBUFFER,_e.__webglColorRenderbuffer[ve]);const Z=n.get(v[ve]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ve,s.TEXTURE_2D,Z,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const v=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[v])}}}function ge(A){return Math.min(i.maxSamples,A.samples)}function Ge(A){const v=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Ee(A){const v=o.render.frame;u.get(A)!==v&&(u.set(A,v),A.update())}function Ne(A,v){const B=A.colorSpace,q=A.format,$=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||B!==Rt&&B!==Ln&&(He.getTransfer(B)===et?(q!==Ht||$!==sn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),v}function ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=D,this.setTexture2D=X,this.setTexture2DArray=G,this.setTexture3D=j,this.setTextureCube=V,this.rebindTextures=at,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=nt,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=Ge}function s_(s,e){function t(n,i=Ln){let r;const o=He.getTransfer(i);if(n===sn)return s.UNSIGNED_BYTE;if(n===$o)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Zo)return s.UNSIGNED_SHORT_5_5_5_1;if(n===il)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===tl)return s.BYTE;if(n===nl)return s.SHORT;if(n===as)return s.UNSIGNED_SHORT;if(n===jo)return s.INT;if(n===ii)return s.UNSIGNED_INT;if(n===jt)return s.FLOAT;if(n===ps)return s.HALF_FLOAT;if(n===sl)return s.ALPHA;if(n===rl)return s.RGB;if(n===Ht)return s.RGBA;if(n===ls)return s.DEPTH_COMPONENT;if(n===us)return s.DEPTH_STENCIL;if(n===Jo)return s.RED;if(n===Qo)return s.RED_INTEGER;if(n===ol)return s.RG;if(n===ea)return s.RG_INTEGER;if(n===ta)return s.RGBA_INTEGER;if(n===Ks||n===js||n===$s||n===Zs)if(o===et)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===$s)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Zs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===$s)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Zs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===po||n===mo||n===go||n===_o)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===po)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===mo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===go)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===_o)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===vo||n===xo||n===Mo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===vo||n===xo)return o===et?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Mo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===yo||n===So||n===Eo||n===To||n===bo||n===Ao||n===wo||n===Ro||n===Co||n===Io||n===Po||n===Lo||n===Do||n===Uo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===yo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===So)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Eo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===To)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===bo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ao)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===wo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ro)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Co)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Io)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Po)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Lo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Do)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Uo)return o===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Js||n===No||n===Fo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Js)return o===et?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===No)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Fo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===al||n===Oo||n===Bo||n===ko)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Js)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Oo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Bo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ko)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===cs?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const r_=`
void main() {
