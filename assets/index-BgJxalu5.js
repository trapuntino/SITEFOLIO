...
`)+`
`+f);const E=T+m+o,M=T+f+a,I=Pc(i,i.VERTEX_SHADER,E),A=Pc(i,i.FRAGMENT_SHADER,M);i.attachShader(_,I),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(R){if(s.debug.checkShaderErrors){const C=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(I).trim(),k=i.getShaderInfoLog(A).trim();let G=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,I,A);else{const $=Dc(i,I,"vertex"),W=Dc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
