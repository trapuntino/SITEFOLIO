...
`)+`
`+f);const E=S+m+o,M=S+f+a,R=Pc(i,i.VERTEX_SHADER,E),C=Pc(i,i.FRAGMENT_SHADER,M);i.attachShader(_,R),i.attachShader(_,C),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(s.debug.checkShaderErrors){const L=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(R).trim(),V=i.getShaderInfoLog(C).trim();let Y=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,R,C);else{const $=Dc(i,R,"vertex"),H=Dc(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
