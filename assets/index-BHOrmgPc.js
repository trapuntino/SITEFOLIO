...
`].filter(is).join(`
`)),o=Xo(o),o=Uc(o,t),o=Nc(o,t),a=Xo(a),a=Uc(a,t),a=Nc(a,t),o=Fc(o),a=Fc(a),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+f);const E=S+m+o,x=S+f+a,w=Pc(i,i.VERTEX_SHADER,E),C=Pc(i,i.FRAGMENT_SHADER,x);i.attachShader(v,w),i.attachShader(v,C),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function A(P){if(s.debug.checkShaderErrors){const L=i.getProgramInfoLog(v).trim(),O=i.getShaderInfoLog(w).trim(),V=i.getShaderInfoLog(C).trim();let Y=!0,W=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,w,C);else{const $=Dc(i,w,"vertex"),H=Dc(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
